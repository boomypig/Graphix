...
class ChessSet {
    ...
    draw(gl, shaderProgram, currentTime) {
        ...
        this.drawAt(gl, shaderProgram, "rook", 1, 0, 1, 1, 2, 1); 
        this.drawAt(gl, shaderProgram, "knight", 2, 0, 1); 
        this.drawAt(gl, shaderProgram, "bishop", 3, 0, 1); 
        this.drawAt(gl, shaderProgram, "queen", 4, 0, 1); 
        this.drawAt(gl, shaderProgram, "king", 5, 0, 1,   1,1,1, -45, 0,0,1); 
        this.drawAt(gl, shaderProgram, "pawn", 5, 0, 2); 
        ...
        for (let x=1; x<=8; x++){
            this.drawAt(gl, shaderProgram, "pawn", x, 0, 7); 
        }
